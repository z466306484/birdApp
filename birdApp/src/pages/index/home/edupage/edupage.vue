  ...
  export default {
    ...
    data() {
      return {
        cheight:'',
        navarr:[
          {type:0,val:'视频教程',color:'rgb(255,150,0)',border:'2px solid rgb(255,150,0)'},
          {type:1,val:'在线阅读',color:'rgb(0,0,0)',border:'none'},
          {type:2,val:'音频教程',color:'rgb(0,0,0)',border:'none'},
        ],
        alllist:[
    ...
    created() {
      if(this.$route.query.id){
        ...
        if(this.$route.query.val){
          this.topobj.t_title = this.$route.query.val
        }
      }
